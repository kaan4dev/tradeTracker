...
public class GetAllTradesResponse
{
	...
	public GetAllTradesResponse(int id, String name, double entryPrice, double exitPrice, double averagePrice, int x,double margin, String longOrShort, String entryDate, String exitDate, double profitLoss)
	{
		this.id = id;
		this.name = name;
